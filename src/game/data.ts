...
export const CHARACTERS: CharacterDefinition[] = [
  ...
  { id: 'cinder', name: 'Scarlet', epithet: 'The Ashborn', glyph: '◆', color: '#ff735c', description: 'Turns packed hordes into kindling.', startingHearts: 5, baseAbility: 'Kindling — weapon hits ignite enemies.', activeAbility: 'Firebrand — release an igniting ring of flame.', activeCooldown: 10, awakening: 'Flashover — burning enemies explode on death.', origin: 'Irish-American · 26', build: 'Petite, softly curvy, freckled', visualIdentity: 'Enormous copper curls, gray-green eyes, light gunfighter armor, bare arms, and a red scarf cut from an old protest banner.', lore: 'A city organizer before the Collapse, Scarlet now runs medicine through curfew lines and burns the regime’s corpse-factories.' },
  { id: 'bastion', name: 'Ama', epithet: 'The Oathbound', glyph: '⬡', color: '#74d8c2', description: 'A field captain who makes danger break around her.', startingHearts: 6, baseAbility: 'Bulwark — starts with a sixth heart; nearby allies take 18% less damage.', activeAbility: 'Aegis Pulse — protect nearby allies and crush the surrounding horde.', activeCooldown: 14, awakening: 'Hold the Line — the aura doubles in range and strength.', origin: 'Ghanaian-English · 28', build: 'Petite, lean-hourglass, lightly athletic', visualIdentity: 'Warm deep-brown skin, expressive almond eyes, natural curls in a low ponytail, and light teal civil-defense armor with hand-etched gold details.', lore: 'Ama Bennett earned the callsign Bastion as a civil-defense captain. When the provisional government ordered the infected districts sealed, she turned her precinct into a sanctuary and held its doors open.' },
  { id: 'warden', name: 'Aiko', epithet: 'The Last Light', glyph: '✚', color: '#b6a5ff', description: 'Carries survivors home when the sirens stop.', startingHearts: 5, baseAbility: 'Second Wind — revive allies 50% faster.', activeAbility: 'Mending Light — restore one heart to the squad.', activeCooldown: 16, awakening: 'Grace — living hunters slowly regenerate health.', origin: 'Japanese · 29', build: 'Petite, compact, softly athletic', visualIdentity: 'Soft heart-shaped face, dark almond eyes, a beauty mark beneath her left eye, waist-length black hair, repaired indigo shrine coat and signal lantern.', lore: 'Aiko was an emergency physician in Yokohama’s last vertical shelter. She crossed the dead rail to find the patients the evacuation authority abandoned.' },
  { id: 'nyx', name: 'Nyx', epithet: 'The Veilblade', glyph: '☾', color: '#7f8cff', description: 'Slips between blows and cuts through crowded lanes.', startingHearts: 5, baseAbility: 'Veilstep — 16% chance to evade incoming damage.', activeAbility: 'Nightstep — blink through danger and become briefly untouchable.', activeCooldown: 9, awakening: 'Night Without End — evades become 28% and grant haste.', origin: 'Greek · 24', build: 'Short, wiry-curvy, agile', visualIdentity: 'Sharp Mediterranean features, enormous waist-length black curls, indigo hood, curved blade and scavenged ceramic plates.', lore: 'A rooftop courier from the drowned Athens arcology, she stole a route-key that proves the night gates are being opened from inside.' },
  { id: 'tempest', name: 'Tempest', epithet: 'The Stormheart', glyph: 'ϟ', color: '#65bfff', description: 'Makes every target the start of a lightning storm.', startingHearts: 5, baseAbility: 'Conduction — every projectile chains once.', activeAbility: 'Cloudbreak — call lightning onto the nearest enemy pack.', activeCooldown: 10, awakening: 'Supercell — chains travel farther and strike harder.', origin: 'Puerto Rican · 27', build: 'Compact, balanced athlete', visualIdentity: 'Golden-tan skin, enormous silver-white braided high ponytail, sleeveless cobalt storm jacket, one insulated shoulder guard and a compact coil carbine.', lore: 'A San Juan grid engineer who kept hurricane shelters powered before the Black Signal turned the electrical network into a weapon.' },
  { id: 'briar', name: 'Briar', epithet: 'The Bloodrose', glyph: '❧', color: '#e45d82', description: 'Feeds on the horde and punishes anything that closes.', startingHearts: 5, baseAbility: 'Bloodbloom — kills restore a sliver of health.', activeAbility: 'Rosewake — erupt thorns around you and drink their damage.', activeCooldown: 12, awakening: 'Red Spring — healing doubles and excess becomes armor.', origin: 'Slavic-European · 31', build: 'Slim-to-average, softly curvy', visualIdentity: 'Broad angular cheekbones, cool-grey eyes, very long dark auburn-brown S-waves and a living rose lattice growing through black reclamation armor.', lore: 'A seed-vault botanist who grafted the plague-resistant bloodrose into herself when the containment authority began burning the last viable samples.' },
