...
const CHARACTER_PORTRAITS: Partial<Record<PlayerConfig['character'], string>> = { cinder: 'cinder-portrait.webp', warden: 'aiko-portrait.webp', rapunsel: 'rapunsel-portrait.webp', eira: 'eira-portrait.webp', mara: 'mara-portrait.webp', zahra: 'zahra-portrait.webp' }
...
const upgradeSceneStyle = (character: PlayerConfig['character'], variant: number) => character === 'rapunsel' || character === 'cinder'
